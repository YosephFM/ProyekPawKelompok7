        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active"
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/dashboard">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  " href="https://corporate-ui-dashboard-laravel.creative-tim.com/tables">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="https://corporate-ui-dashboard-laravel.creative-tim.com/wallet">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="https://corporate-ui-dashboard-laravel.creative-tim.com/RTL">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 "
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/laravel-examples/user-profile">
                    <span class="nav-link-text ms-1">User Profile</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 "
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/laravel-examples/users-management">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 "
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/profile">
                    <span class="nav-link-text ms-1">Profile</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 "
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/signin">
                    <span class="nav-link-text ms-1">Sign In</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 "
                    href="https://corporate-ui-dashboard-laravel.creative-tim.com/signup">
    ...
    <div class="container-fluid py-1 px-2">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <div class="mb-0 font-weight-bold breadcrumb-text text-white">
                <form method="POST" action="https://corporate-ui-dashboard-laravel.creative-tim.com/logout">
                    <input type="hidden" name="_token" value="P70pqMJklHSsHeRHJaggFxtoHbXgwDuZ0MRvd77h">
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"94a7bd863c099cff","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"version":"2025.5.0","token":"1b7cbb72744b40c580f8633c6b62637e"}' crossorigin="anonymous"></script>
</body>
